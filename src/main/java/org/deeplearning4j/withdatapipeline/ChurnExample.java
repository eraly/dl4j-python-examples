...
public class ChurnExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaRDD<String> stringData = sc.textFile(new ClassPathResource("datapipeline/churn/train/Churn_Modelling_00.csv").getFile().getPath());
        ...
        String featurizedCSVPath = new ClassPathResource("datapipeline/churn/train/Churn_Modelling_00_processed.csv").getFile().getAbsolutePath();
        System.out.println(featurizedCSVPath);
        Files.write(Paths.get(featurizedCSVPath), featurizedCSV, Charset.defaultCharset());
